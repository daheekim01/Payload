...
| **특징**       | **HTML 엔티티 (HTML Entities)**                   | **HTML 이스케이프 문자 (HTML Escape Characters)**     |
| ------------ | ---------------------------------------------- | ---------------------------------------------- |
| **목적**       | 특수 문자를 HTML 문서에서 **안전하게 표시**하기 위해 사용           | HTML 내에서 **특수 문자가 해석되지 않도록 안전하게 변환**하기 위해 사용   |
| **주요 사용 환경** | HTML 문서에서 특수 문자를 표시하는 데 사용                     | HTML 코드 내에서 사용자 입력을 안전하게 처리하고 출력하는 데 사용        |
| **기호**       | `&`로 시작하고 `;`로 끝남 (예: `&lt;`, `&gt;`, `&amp;`) | `&`로 시작하고 `;`로 끝남 (예: `&lt;`, `&gt;`, `&amp;`) |
| **주요 예시**    | `&lt;`, `&gt;`, `&quot;`, `&amp;`, `&apos;`    | `&lt;`, `&gt;`, `&quot;`, `&amp;`, `&apos;`    |
| **보안 관련 사용** |  **보통 보안과는 관계없음**                                   |  **XSS 방지 등 보안적 목적에서 중요하게 사용**                      |
| **일반적인 용도**  | HTML 문서 내에서 텍스트로 출력할 때 특수 문자를 안전하게 표현하기 위해 사용  | 사용자 입력을 처리하여 **HTML 태그가 실행되지 않도록 변환**할 때 사용    |
