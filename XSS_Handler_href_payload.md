...
다음은 **가용성을 침해하지 않으면서도** **XSS 공격 테스트**를 할 수 있는 여러 **`<a href="javascript:...">`** 형식의 페이로드들을 나열한 것입니다. 이들은 **단순히 JavaScript 코드 실행**에 그치며, 페이지를 변경하거나 서버와의 상호작용 없이 **브라우저 내에서만 동작**합니다.
