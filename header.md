아, 요청을 보낼 때 악용하는 방식에 대한 페이로드 예시를 원하시는 거군요! 각 헤더가 노출되었을 때, 공격자가 해당 정보를 어떻게 활용하여 **악성 요청**을 보낼 수 있는지에 대한 예시를 제공하겠습니다.
...
이와 같이 **헤더 정보**가 노출되면 공격자는 그에 맞는 **악성 요청**을 보낼 수 있습니다. 각 헤더는 공격자가 **서버의 기술 스택**, **보안 상태**, \*\*응답
