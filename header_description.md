...
---
물론이죠! 이전에 설명드린 `Strict-Transport-Security`와 `Referrer-Policy` 헤더 관련 내용을 아래와 같이 **요청하신 형식에 맞춰** 정리해드릴게요:
...
좋습니다! 이어서 주요 보안 헤더인 `Permissions-Policy`, `X-Content-Type-Options`, `Content-Security-Policy`를 요청하신 형식에 맞춰 정리해드릴게요.
